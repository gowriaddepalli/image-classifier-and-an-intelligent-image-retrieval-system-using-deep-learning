...
+ comparative analysis using basic image features and deep features for image classification using logistic regression and boosted tree classifier, achieving the accuracy of 47% and 53% respectively in case of image features and 78% and 76% respectively using deep features.
